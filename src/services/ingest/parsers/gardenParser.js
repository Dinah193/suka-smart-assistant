// src/services/ingest/parsers/gardenParser.js
// -----------------------------------------------------------------------------
// gardenParser
// -----------------------------------------------------------------------------
...
export default async function gardenParser(artifact) {
  ...
  const lexMatches = [
    ...LayerRegistry.scanTextWithLexicon({ text, lexiconIdOrDomain: "garden", maxMatches: 90 }),
    ...LayerRegistry.scanTextWithLexicon({ text, lexiconIdOrDomain: "homestead", maxMatches: 40 }),
    ...LayerRegistry.scanTextWithLexicon({ text, lexiconIdOrDomain: "preservation", maxMatches: 30 }),
