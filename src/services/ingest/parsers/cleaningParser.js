// src/services/ingest/parsers/cleaningParser.js
// -----------------------------------------------------------------------------
// cleaningParser
// -----------------------------------------------------------------------------
...
export default async function cleaningParser(artifact) {
  ...
  const lexMatches = [
    ...LayerRegistry.scanTextWithLexicon({ text, lexiconIdOrDomain: "cleaning", maxMatches: 90 }),
