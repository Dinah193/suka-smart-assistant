...
json
Copy code
{ "entityId": "recipe-xyz", "platform": "YouTube", "videoId": "abcd1234" }
3) Typical Flows
...
sequenceDiagram
  ...
  AR-->>AR: automation.suggestion.emitted
...
Analytics can subscribe to *.executed, inventory.updated, automation.*, validation.*.
...
Session Factory/Store/Runner → session.*, *.executed
