...
try {
  SavePlanButton = require("@/components/plans/SavePlanButton.jsx").default;
} catch (_e) {}

let FavoritePicker = null; // optional picker UI
try {
  FavoritePicker = require("@/components/plans/FavoritePicker.jsx").default;
} catch (_e) {}

/* ------------------------------- Fallback data ----------------------------- */
let TopicsRegistry = null;
try {
  TopicsRegistry = require("@/data/topics.registry").default;
} catch (_e) {}
...
const BUILTIN_TOPICS = [
  /* ------------------------------ MEALS ----------------------------------- */
  {
    ...
    domain: "meals",
    tags: ["baking", "dessert", "evergreen", "whole-grain"],
    popularity: 98,
  },
  {
    id: "french-toast",
  ...
  },
  {
    ...
    title: "Apple Crumble",
    domain: "meals",
    tags: ["dessert", "baking", "seasonal"],
    popularity: 88,
  },
  {
    id: "smash-burgers",
    title: "Smash Burgers Night",
    domain: "meals",
    tags: ["dinner", "grilling", "crowd-pleaser"],
    popularity: 90,
  },
  {
    id: "desserts-index",
    title: "Desserts (Master Index)",
    domain: "meals",
    tags: ["evergreen", "index"],
    popularity: 85,
  },
  {
    id: "lasagna-classic",
    title: "Classic Lasagna (Batchable)",
    domain: "meals",
    tags: ["dinner", "batchable", "freezer"],
    popularity: 95,
  },
  {
    id: "house-bitters",
    title: "Homemade Bitters",
    domain: "meals",
    tags: ["beverage", "infusion", "pantry"],
    popularity: 72,
  },
  {
    id: "bakery-basics",
    title: "Bakery Basics",
    domain: "meals",
    tags: ["baking", "flour", "grains", "technique"],
    popularity: 80,
  },
  {
    id: "fresh-ground-flour",
    title: "Fresh-Ground Whole-Grain Flour Guide",
    domain: "meals",
    tags: ["baking", "whole-grain", "health"],
    popularity: 86,
  },
  {
    id: "meal-prep-starters",
    title: "Meal-Prep Starters (Protein + Bases)",
    domain: "meals",
    tags: ["prep", "freezer", "batchable"],
    popularity: 83,
  },
  {
    id: "pressure-canned-broth",
    title: "Pressure-Canned Bone Broth",
    domain: "meals",
    tags: ["canning", "pantry", "batchable"],
    popularity: 79,
  },
  ...
  /* ----------------------------- CLEANING --------------------------------- */
  {
    ...
    domain: "cleaning",
    tags: ["routine", "evergreen", "streak"],
    popularity: 91,
  },
  {
    id: "weekly-zones",
    title: "Weekly Zone Clean (5-Zone Cycle)",
    domain: "cleaning",
    tags: ["planner", "zones", "evergreen"],
    popularity: 89,
  },
  {
    id: "laundry-system",
    title: "Laundry System (Queues + Folds)",
    domain: "cleaning",
    tags: ["laundry", "workflow"],
    popularity: 84,
  },
  {
    id: "homemade-cleaners",
    title: "Homemade Cleaners (Vinegar, Citrus, Soap)",
    domain: "cleaning",
    tags: ["DIY", "non-toxic", "pantry"],
    popularity: 82,
  },
  {
    id: "bathroom-deep-clean",
    title: "Bathroom Deep Clean (Runbook)",
    domain: "cleaning",
    tags: ["deep-clean", "checklist"],
    popularity: 80,
  },
  {
    id: "floor-care",
    title: "Floor Care (Sweep/Vac/Mop Cadence)",
    domain: "cleaning",
    tags: ["routine", "cadence"],
    popularity: 78,
  },
  {
    id: "windows-mirrors",
    title: "Windows & Mirrors (No-Streak)",
    domain: "cleaning",
    tags: ["technique", "shine"],
    popularity: 75,
  },
  {
    id: "15min-declutter",
    title: "15-Minute Declutter Sprints",
    domain: "cleaning",
    tags: ["declutter", "quick-win"],
    popularity: 87,
  },
  ...
  {
    id: "seed-starting",
    title: "Seed Starting (Lights + Schedule)",
    domain: "garden",
    tags: ["propagation", "calendar"],
    popularity: 90,
  },
  {
    id: "transplant-beds",
    title: "Transplant Beds (Prep + Spacing)",
    domain: "garden",
    tags: ["soil", "layout", "plan"],
    popularity: 88,
  },
  {
  ...
  {
    id: "composting",
    title: "Composting (Hot/Cold/Sheet)",
    domain: "garden",
    tags: ["soil", "inputs", "evergreen"],
    popularity: 84,
  },
  {
    id: "mulch-strategy",
    title: "Mulch Strategy (Weeds + Moisture)",
    domain: "garden",
    tags: ["weed-control", "water"],
    popularity: 80,
  },
  {
    id: "irrigation-cycles",
    title: "Irrigation & Dynamic Watering Cycles",
    domain: "garden",
  ...
  {
    id: "pest-management",
    title: "Pest Management (ID → Action)",
    domain: "garden",
    tags: ["ipm", "safety"],
    popularity: 79,
  },
  {
    id: "harvest-logging",
    title: "Harvest Logging → Inventory Sync",
    domain: "garden",
    tags: ["inventory", "preserve"],
    popularity: 83,
  },
  {
    id: "soil-testing",
    title: "Soil Testing & Amendments Map",
    domain: "garden",
    tags: ["soil", "health"],
    popularity: 77,
  },
  ...
  {
    id: "poultry-daily",
    title: "Poultry Daily Care",
    domain: "animals",
    tags: ["checklist", "feeding", "watering"],
    popularity: 88,
  },
  {
    id: "egg-handling",
    title: "Egg Handling & Rotation",
    domain: "animals",
  ...
  {
    id: "goat-milking",
    title: "Goat Milking Routine (Sanitation)",
    domain: "animals",
    tags: ["milking", "sanitation"],
    popularity: 82,
  },
  {
    id: "on-farm-butchery",
    title: "On-Farm Butchery (All Species)",
    domain: "animals",
    tags: ["butchery", "workflow", "PPE"],
    popularity: 86,
  },
  {
    id: "red-meat-dropoff",
    title: "Red Meat Drop-Off Scheduling (USDA/State)",
    domain: "animals",
  ...
  {
    id: "brooder-setup",
    title: "Brooder Setup → Grow-Out",
    domain: "animals",
    tags: ["poultry", "brooder"],
    popularity: 80,
  },
  {
    id: "pasture-rotation",
  ...
  {
    id: "predator-proofing",
    title: "Predator-Proofing Check",
    domain: "animals",
    tags: ["security", "night-lock"],
    popularity: 79,
  },
  {
    id: "feed-inventory",
    title: "Feeds & Supplements Inventory",
    domain: "animals",
...
async function saveUserTopic(topic) {
  try {
    if (DexieDB?.topics) {
      await DexieDB.topics.put(topic);
      return;
    }
  } catch (_e) {}
  if (!isBrowser) return;
  ...
  if (idx >= 0) prev[idx] = topic;
  else prev.push(topic);
...
async function deleteUserTopic(id) {
  ...
  localStorage.setItem(
    LS_TOPICS_KEY,
    safeJSON.stringify(prev.filter((t) => t.id !== id))
  );
}
...
function Pill({ children, className = "" }) {
  return (
    <span
      className={`inline-block px-2 py-0.5 text-xs rounded-full border ${className}`}
    >
      {children}
    </span>
  );
    ...
    <div className="rounded-2xl border shadow-sm p-4 flex flex-col gap-3 hover:shadow-md transition">
      ...
      {!!(topic.tags && topic.tags.length) && (
        <div className="flex flex-wrap gap-1.5">
          {topic.tags.map((t) => (
            <Pill key={t} className="opacity-70">
              {t}
            </Pill>
          ))}
        </div>
...
export default function TopicsIndexPage() {
  ...
  const baseTopics = useMemo(() => {
    if (Array.isArray(TopicsRegistry) && TopicsRegistry.length)
  ...
  const filtered = useMemo(() => {
    ...
    if (domain !== "all")
      list = list.filter((t) => (t.domain || "other") === domain);

    if (activeTags.length) {
      list = list.filter((t) =>
        (t.tags || []).some((x) => activeTags.includes(x))
      );
    }
    ...
    if (sortKey === "alpha")
      ...
      list = [...list].sort(
        (a, b) => new Date(b.createdISO || 0) - new Date(a.createdISO || 0)
      );
    else
      list = [...list].sort(
  ...
  function handleCreatePlan(topic) {
    ...
    eventBus.emit?.("toast", {
      kind: "info",
      message: "Creating plan from topic…",
      tsISO: toISO(),
    });
  }
    ...
    <div className="p-4 md:p-6 lg:p-8">
      <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="opacity-70">
            Curate evergreen topics across Meals, Cleaning, Garden, and Animals.
            Spin up plans and save your best as favorites (local, Drive, or
            cloud).
          </p>
        </div>
      ...
      {!!tagsUniverse.length && (
        <div className="mb-5 flex flex-wrap gap-1.5">
          ...
          {!!activeTags.length && (
            <button
              className="ml-2 px-3 py-1 rounded-full border hover:bg-black/5"
      ...
      {filtered.length === 0 ? (
        <div className="border rounded-2xl p-8 text-center opacity-70">
          No topics match your filters. Try clearing filters or adding a new
          topic.
        </div>
      ) : groupByDomain ? (
        <DomainSections
...
function DomainSections({ items, onCreatePlan, onFavorite, onDelete }) {
  const groups = useMemo(() => {
    ...
    items.forEach((t) =>
      g[t.domain] ? g[t.domain].push(t) : (g[t.domain] = [t])
    );
    return g;
  }, [items]);
